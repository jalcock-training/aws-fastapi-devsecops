...
This document provides a practical cost breakdown for the aws-fastapi-devsecops architecture. It
focuses on the major cost‑bearing components: ECS Fargate, Application Load Balancer (ALB), NAT
Gateway, and CloudWatch Logs.
...
ECS Fargate charges for vCPU-hours and GB-hours. You pay only for the resources allocated to your
running tasks.

### What you pay for - ECS Fargate

1. vCPU per hour
1. Memory (GB) per hour
1. Optional: additional ephemeral storage beyond the free baseline

### Example configuration - ECS Fargate

- 0.25 vCPU
- 0.5 GB RAM
- 1 task running 24/7

### Cost drivers - ECS Fargate
...
### What you pay for - NAT GW

1. NAT Gateway hourly charge
1. Data processed (per GB)

### Why NAT costs can spike - NAT GW
...
### Cost optimisation options - NAT GW
